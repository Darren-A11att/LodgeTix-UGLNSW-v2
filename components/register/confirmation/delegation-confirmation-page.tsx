...
interface DelegationConfirmationPageProps {
  registration: {
    ...
    delegationDetails: {
      delegationType: 'grandLodge' | 'masonicOrder';
...
export default function DelegationConfirmationPage({ registration }: DelegationConfirmationPageProps) {
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Delegation Registration Confirmed</h1>
          <p className="text-lg text-gray-600">Thank you for your delegation registration</p>
        </div>
        ...
        <Card className="shadow-lg">
          ...
          <CardContent className="p-6">
            ...
            {/* Delegation Registration Details */}
            <div className="mb-8">
              <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                🏛️ Delegation Details
              </h3>
              
              <div className="bg-gray-50 rounded-lg p-6 border">
                <div className="mb-4">
                  <p className="text-xl font-semibold text-gray-900">
                    {registration.delegationDetails.delegationType === 'grandLodge' ? 'Grand Lodge Delegation' : 'Masonic Order Delegation'}
                  </p>
                  <p className="text-gray-600 mt-1">
                    {registration.delegationDetails.grandLodgeName || registration.delegationDetails.organisationName}
                    {registration.delegationDetails.organisationAbbreviation && (
                      <span className="text-gray-500"> ({registration.delegationDetails.organisationAbbreviation})</span>
                    )}
                  </p>
                </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm">
                      ...
                      <p className="text-yellow-700 mb-2">
                        This delegation registration reserves tickets for your organisation. Individual delegate details can be provided closer to the event.
                      </p>
                      <p className="text-yellow-700">
                        Please ensure all delegates have separately registered for the Proclamation Ceremony if required.
                      </p>
                    </div>
                  </div>
                </div>
