# Task 043: Create AdditionalInfo Section

## Objective
Create the AdditionalInfo component that handles dietary requirements and special needs for all attendee types.

## Dependencies
- Task 025 (field components)

## Reference Files
- `components/register/oldforms/mason/MasonAdditionalInfo.tsx`
- `components/register/oldforms/guest/GuestAdditionalInfo.tsx`

## Steps

1. Create `components/register/forms/basic-details/AdditionalInfo.tsx`:
```typescript
...
2. Create an enhanced version with common dietary options:
```typescript
// Enhanced version with common options
...
## Deliverables
- AdditionalInfo component for all attendee types
- Enhanced version with common dietary options
- Backward compatibility wrappers
- Consistent field handling

## Success Criteria
- Works for all attendee types
- Dietary requirements field preserved
- Special needs field preserved
