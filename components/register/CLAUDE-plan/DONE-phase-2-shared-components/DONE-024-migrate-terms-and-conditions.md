# Task 024: Migrate TermsAndConditions

## Objective
Migrate the TermsAndConditions component to the shared location with proper typing and accessibility improvements.

## Dependencies
- Phase 1 foundation complete

## Reference Files
- `components/register/functions/TermsAndConditions.tsx`

## Steps

1. Copy and refactor TermsAndConditions:
```typescript
// components/register/forms/shared/TermsAndConditions.tsx
...
2. Create specialized versions for different contexts:
```typescript
...
## Deliverables
- Migrated TermsAndConditions component
- Modal display for full terms
- Specialized versions for different uses
- Proper error handling and accessibility

## Success Criteria
- Component handles all existing use cases
