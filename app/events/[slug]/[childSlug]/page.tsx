...
import { getEventTickets } from "@/lib/services/event-tickets-service"
...
export default async function ChildEventPage({ 
  ...
  // Also fetch parent event for navigation
  const parentEvent = await getEventByIdOrSlug(parentSlug)
  ...
  // Fetch tickets for this specific child event
      ...
      <header className="sticky top-0 z-10 flex h-14 items-center justify-between border-b bg-white px-4 md:px-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button size="sm" asChild>
            <Link href={`/events/${parentSlug}/register`}>Get Tickets</Link>
          </Button>
        </div>
      </header>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            <Card className="sticky top-20">
              ...
              <CardFooter>
                <Button className="w-full" asChild disabled={!tickets || tickets.length === 0}>
