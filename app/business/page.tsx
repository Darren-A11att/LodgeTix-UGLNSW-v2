...
export default function SoftwareLandingPage() {
  const features: Feature[] = [
    ...
    },
    {
      ...
      description: "Manage catering companies, venue suppliers, and service providers. Automate dietary requirements transmission to caterers.",
      icon: <Building className="h-6 w-6" />
    },
    {
      title: "Expense & Finance Tracking",
      description: "Lightweight accounting module specifically for event budgeting, expense tracking, and financial reporting.",
          ...
          <div className="text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button asChild size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-masonic-navy">
                <Link href="/business/about/contact">Book a Demo</Link>
              </Button>
            </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-masonic-navy">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button asChild size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-masonic-navy">
              <Link href="/business/about/contact">
                Schedule a Demo
