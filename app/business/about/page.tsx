...
const aboutMenuItems = [
  { name: 'About Us', href: '/business/about', current: true },
      ...
      <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-5xl font-semibold tracking-tight text-white sm:text-7xl">About {COMPANY_INFO.tradingName}</h2>
            <p className="mt-8 text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">
              {BRAND_POSITIONING.marketing}
            </p>
          </div>
      ...
      <div className="bg-white px-6 py-32 lg:px-8">
        <div className="mx-auto max-w-3xl text-base/7 text-gray-700">
          ...
          <h1 className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl">
            {BRAND_POSITIONING.secondary}
          </h1>
          <p className="mt-6 text-xl/8">
            {COMPANY_DESCRIPTIONS.saas}
          </p>
          <div className="mt-10 max-w-2xl">
            
            <p className="mt-6">
              {COMPANY_DESCRIPTIONS.medium}
            </p>
          ...
          <div className="mt-16 max-w-2xl">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              <Button asChild size="lg">
                <Link href="/business/about/contact">Contact Us</Link>
              </Button>
            </div>
          </div>
        </div>
