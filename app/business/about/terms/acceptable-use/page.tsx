...
export default function AcceptableUsePage() {
  ...
  useEffect(() => {
    fetch('/legal-docs/acceptable-use-policy.md')
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold text-masonic-navy mb-8">Acceptable Use Policy</h1>
        
        {loading ? (
          <div className="text-center py-12">
            <p className="text-gray-500">Loading Acceptable Use Policy...</p>
          </div>
        ) : (
