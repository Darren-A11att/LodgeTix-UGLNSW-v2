...
const supportCards = ContactDisplayData.supportCards.map((card, index) => ({
  ...card,
  icon: index === 0 ? LifebuoyIcon : index === 1 ? PhoneIconSolid : NewspaperIcon
}))

const aboutMenuItems = [
  { name: 'About Us', href: '/business/about', current: false },
  { name: 'Contact', href: '/business/about/contact', current: true },
  { name: 'Legal & Terms', href: '/business/about/terms', current: false },
]
            ...
            <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
              ...
              <dl className="mt-10 space-y-4 text-base/7 text-gray-600">
                <div className="flex gap-x-4">
                  ...
                  <dd>
                    {CompanyFormatters.getTradingName()}
                    <br />
                    ABN: {COMPANY_INFO.abn}
                    <br />
                    {COMPANY_INFO.address.street}
                    <br />
                    {COMPANY_INFO.address.suburb} {COMPANY_INFO.address.state} {COMPANY_INFO.address.postcode}
                  </dd>
                </div>
                <div className="flex gap-x-4">
                  <dt className="flex-none">
                  ...
                  <dd>
                    <a href={CompanyFormatters.getPhoneLink()} className="hover:text-gray-900">
                ...
                <div className="flex gap-x-4">
                  ...
                  <dd>
                    <a href={CompanyFormatters.getEmailLink(true)} className="hover:text-gray-900">
