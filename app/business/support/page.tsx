...
import { COMPANY_INFO, CompanyFormatters, ContactDisplayData } from '@/lib/constants/company-details'
...
const supportCards = ContactDisplayData.supportCards.map((card, index) => ({
  ...card,
  description: index === 0 
    ? 'Registration assistance, account management, platform guidance, and lodge member support.'
    : index === 1
    ? 'Technical issues, payment problems, troubleshooting, and platform functionality support.'
    : 'Masonic event questions, lodge protocols, guest arrangements, and ceremonial requirements.',
  icon: index === 0 ? LifebuoyIcon : index === 1 ? PhoneIcon : NewspaperIcon
}))
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{COMPANY_INFO.contact.supportEmail}</p>
