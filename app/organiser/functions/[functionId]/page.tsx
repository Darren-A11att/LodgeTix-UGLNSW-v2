...
import { publishFunction } from '@/app/organiser/actions'
      ...
      <div className="space-y-4">
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="outline" size="sm" asChild>
              <Link href={`/organiser/functions/${params.functionId}/edit`}>
            ...
            <form action={async () => {
              'use server'
              await publishFunction(params.functionId, !functionData.is_published)
            }}>
