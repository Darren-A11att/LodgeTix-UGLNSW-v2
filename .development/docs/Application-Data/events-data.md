...
This file contains seed data for events in the LodgeTix application.

## Grand Installation Event

```json
{
  "id": "grand-installation-2023",
  ...
  "relatedEvents": ["grand-banquet-2023", "farewell-brunch-2023", "sydney-harbour-cruise-2023"],
...
## Farewell Brunch Event

```json
{
  "id": "farewell-brunch-2023",
  "title": "Farewell Brunch",
...
## Sydney Harbour Cruise Event

```json
{
  "id": "sydney-harbour-cruise-2023",
...
## Third Degree Ceremony Event

```json
{
  "id": "third-degree-ceremony-2023",
  ...
  "organizerId": "lodge-commonwealth-400",
...
## Masonic Education Night Event

```json
{
  "id": "masonic-education-night-2023",
...
## May 2025 Grand Installation

```json
{
  "id": "grand-installation-2025",
  "title": "Grand Installation",
  "subtitle": "MW Bro Bernie Khristian Albano",
