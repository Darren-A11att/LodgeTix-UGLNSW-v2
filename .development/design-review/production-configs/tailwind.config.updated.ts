...
const config = {
  ...
  theme: {
    ...
    extend: {
      ...
      // Colors section remains the same with existing colors
      colors: {
        ...
        secondary: {
          ...
          light: "hsl(var(--secondary-light))", // Added from design system
        },
        destructive: {
      ...
      // Border Radius - Extending with form-specific values
      borderRadius: {
        lg: "var(--radius)",
        md: "calc(var(--radius) - 2px)",
        sm: "calc(var(--radius) - 4px)",
        // Form-specific radius values
      ...
      keyframes: {
        ...
        // Additional keyframes for forms
        shimmer: {
          "100%": {
