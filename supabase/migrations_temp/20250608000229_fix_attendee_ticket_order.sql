-- Fix ticket creation to use correct attendee ID mapping and proper order
...
DECLARE
    ...
    v_status text;
    v_attendee_ticket_map jsonb := '{}';  -- Map of attendee IDs for ticket creation
BEGIN
    ...
    -- Process tickets LAST using the correct attendee IDs
    IF p_registration_data->'tickets' IS NOT NULL THEN
        ...
        LOOP
            ...
            BEGIN
                ...
                -- Insert ticket with correct attendee_id
                INSERT INTO tickets (
                    ticket_id,
                    attendee_id,
                    registration_id,
