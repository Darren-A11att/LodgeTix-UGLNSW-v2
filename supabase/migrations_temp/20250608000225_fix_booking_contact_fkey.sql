-- Fix booking_contact_id foreign key reference issue

-- The error shows that booking_contact_id is supposed to reference customers table
-- but we're inserting a contact ID. Let's fix the function to use the correct reference.
...
BEGIN
    ...
    INSERT INTO registrations (
        ...
        v_booking_contact_id,  -- This now correctly references the customer
