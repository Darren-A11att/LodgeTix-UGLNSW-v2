-- Support anonymous user registrations
-- Allow registrations to be created without authenticated users
...
BEGIN
  ...
  ELSE
    ...
    RAISE NOTICE 'Creating authenticated registration with customer_id: %', v_customer_id;
  END IF;
