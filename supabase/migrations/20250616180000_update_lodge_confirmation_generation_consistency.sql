-- Update lodge registration function to use consistent confirmation number generation
-- matching the centralized service format: LDG-[6 digits][2 letters]
...
BEGIN
  ...
  IF v_status = 'confirmed' THEN
    ...
    IF v_confirmation_number IS NULL OR v_confirmation_number = '' THEN
      -- Generate lodge confirmation number matching centralized service format: LDG-[6 digits][2 letters]
      -- This matches the format from confirmation-number-service.ts
