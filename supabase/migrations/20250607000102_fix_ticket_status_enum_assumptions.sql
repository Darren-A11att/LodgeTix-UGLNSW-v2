-- Fix ticket_status enum assumption errors across all RPC functions
-- The tickets.status column is varchar(50), not an enum type

-- Fix upsert_individual_registration function
...
-- Also fix any other functions that use ticket_status casting
-- Search for and fix any remaining instances in other migration files