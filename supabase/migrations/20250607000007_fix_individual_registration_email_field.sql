-- Fix the email and phone field mapping in upsert_individual_registration function
-- The frontend sends 'email' and 'mobileNumber' but the function expects 'primaryEmail' and 'primaryPhone'
