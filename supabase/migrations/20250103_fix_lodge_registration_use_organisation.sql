-- Fix the upsert_lodge_registration RPC function to use 'organisation' for customer_type
-- For lodge registrations, the customer is the organisation (lodge), not an individual
...
BEGIN
    ...
    -- For lodge registrations, the customer is the organisation
    INSERT INTO customers (
        ...
        p_booking_contact->>'firstName',
        p_booking_contact->>'lastName',
        'organisation'::customer_type  -- Use 'organisation' for lodge registrations
    )
...
-- Add comment
COMMENT ON FUNCTION public.upsert_lodge_registration IS 'Handles lodge registration creation and updates. Uses organisation as customer_type for lodge registrations.';