-- Fix lodge registration to generate confirmation numbers directly without Edge Functions
-- This ensures local development works without requiring Edge Functions
...
DO $$
BEGIN
  RAISE NOTICE 'Updated lodge registration to generate confirmation numbers directly';
  RAISE NOTICE 'No longer depends on Edge Functions for confirmation generation';
  RAISE NOTICE 'Confirmation numbers are generated immediately when payment_status = completed';
END $$;