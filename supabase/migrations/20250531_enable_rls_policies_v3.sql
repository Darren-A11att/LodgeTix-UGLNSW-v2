-- OPTIMIZED RLS POLICIES FOR LODGETIX
-- Version 3: Based on actual app architecture analysis
-- Key insight: Guest checkout uses anonymous authentication (authenticated role with temp auth.uid())
...
-- Users can view their own registrations (via customer_id which stores auth.uid())
