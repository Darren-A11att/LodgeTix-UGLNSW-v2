-- Fix lodge registration function to use correct ticket table columns
-- Remove ticket_type column and use event_ticket_id instead
...
DO $$
BEGIN
  RAISE NOTICE 'Fixed lodge registration function to use event_tickets instead of ticket_type';
  RAISE NOTICE 'Updated ticket creation to use event_id and event_ticket_id columns';
  RAISE NOTICE 'Added proper lookup for event and event_ticket from package';
  RAISE NOTICE 'Function now creates tickets with correct table structure';
END $$;