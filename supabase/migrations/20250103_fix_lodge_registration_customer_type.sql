-- Fix the upsert_lodge_registration RPC function to use correct customer_type enum value
-- customer_type enum only has 'individual' and 'organisation' values
-- For lodge registrations, the booking contact is an individual
...
BEGIN
    ...
    -- For lodge registrations, the booking contact is an individual customer
    INSERT INTO customers (
        ...
        p_booking_contact->>'firstName',
        p_booking_contact->>'lastName',
        'individual'::customer_type  -- Booking contact is an individual
    )
...
-- Add comment
COMMENT ON FUNCTION public.upsert_lodge_registration IS 'Handles lodge registration creation and updates. Fixed to use correct customer_type enum value (individual for booking contact).';