-- Fix the customer_type value in upsert_individual_registration function
-- The customer_type enum only accepts 'booking_contact', 'sponsor', or 'donor'
-- Not 'individual' as was being used
...
BEGIN
    ...
    -- FIXED: Use 'booking_contact' instead of 'individual' for customer_type
    INSERT INTO customers (
        ...
        v_customer_id,
        'booking_contact',  -- FIXED: Was 'individual', now using valid enum value
