-- Fix confirmation views to pull data from proper columns instead of JSONB
-- This migration updates the views to include ticket names and proper attendee/ticket data
...
-- 1. Recreate base view with proper data sources
...
-- 2. Create enhanced individuals view with proper ticket data
...
-- 3. Create lodge view with proper data
...
-- 4. Create delegation view with proper data
...
-- Add comments
COMMENT ON VIEW individuals_registration_confirmation_view IS 'Confirmation view for individual registrations with complete attendee and ticket data from proper tables';
COMMENT ON VIEW lodge_registration_confirmation_view IS 'Confirmation view for lodge registrations with complete member and package data from proper tables';
COMMENT ON VIEW delegation_registration_confirmation_view IS 'Confirmation view for delegation registrations with complete delegate and ticket data from proper tables';