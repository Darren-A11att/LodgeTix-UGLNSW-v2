-- Fix the upsert_lodge_registration RPC function to use 'booking_contact' for customer_type
-- The customer_type enum includes 'booking_contact' as a valid value
...
BEGIN
    ...
    -- Use 'booking_contact' as the customer_type
    INSERT INTO customers (
        ...
        p_booking_contact->>'firstName',
        p_booking_contact->>'lastName',
        'booking_contact'::customer_type  -- Use 'booking_contact' as you specified
    )
