-- Fix the upsert_individual_registration function to match the actual contacts table schema
-- This fixes the field mapping issues between frontend data and database expectations
