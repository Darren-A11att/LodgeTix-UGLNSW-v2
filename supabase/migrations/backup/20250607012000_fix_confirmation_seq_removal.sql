-- Fix upsert_individual_registration to remove registration_confirmation_seq usage
-- This aligns with the removal of confirmation number generation at registration time
...
'Handles individual registration creation and updates. Confirmation numbers are now generated by Edge Function after payment completion. Fixed to remove registration_confirmation_seq dependency.';