-- Update upsert_individual_registration to set organisation_id from primary attendee
...
-- Update upsert_lodge_registration to create tickets for lodge registrations
