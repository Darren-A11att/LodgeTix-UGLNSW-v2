...
COMMENT ON FUNCTION "public"."upsert_individual_registration"("p_registration_data" "jsonb") IS 'Handles individual registration creation and updates. Confirmation numbers are now generated by Edge Function after payment completion. Fixed to remove registration_confirmation_seq dependency.';
...
CREATE TABLE IF NOT EXISTS "public"."tickets" (
    ...
    "qr_code_url" "text",
    CONSTRAINT "check_valid_ticket_status" CHECK ((("status")::"text" = ANY (ARRAY[('available'::character varying)::"text", ('reserved'::character varying)::"text", ('sold'::character varying)::"text", ('used'::character varying)::"text", ('cancelled'::character varying)::"text"]))),
    CONSTRAINT "tickets_status_check" CHECK ((("status")::"text" = ANY (ARRAY[('available'::character varying)::"text", ('reserved'::character varying)::"text", ('sold'::character varying)::"text", ('used'::character varying)::"text", ('cancelled'::character varying)::"text"])))
);
