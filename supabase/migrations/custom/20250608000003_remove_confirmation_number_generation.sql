-- Remove confirmation number generation from upsert_individual_registration
-- Since confirmation numbers are now generated by Edge Function after payment completion
...
'Handles individual registration creation and updates. Confirmation numbers are now generated by Edge Function after payment completion.';