-- Quick fix for customer column names in RPC functions
-- The customers table uses 'phone' and 'address_line1', not 'mobile' and 'address_line_1'

-- Update lodge registration function
...
BEGIN
  ...
  -- Create customer (always create new customer for now)
  ...
  -- Create or update registration with correct financial mapping
