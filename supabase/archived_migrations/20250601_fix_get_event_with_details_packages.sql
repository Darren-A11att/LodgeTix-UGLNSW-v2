-- Fix get_event_with_details RPC function to use correct package columns
-- This fixes the "column p.attendee_limit does not exist" error
        ...
        'packages', COALESCE(
            (SELECT json_agg(
                json_build_object(
                    ...
                    'attendee_limit', p.qty,  -- Using qty instead of attendee_limit
...
'Fetches complete event data including child events, packages, ticket types, and location information. Fixed to use correct package table columns.';