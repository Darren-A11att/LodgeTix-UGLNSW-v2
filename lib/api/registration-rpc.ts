...
// Removed deprecated createRegistrationViaRPC function and USE_RPC_REGISTRATION flag
// The create_registration RPC no longer exists
// Use create_registration_with_attendees RPC or direct database inserts instead