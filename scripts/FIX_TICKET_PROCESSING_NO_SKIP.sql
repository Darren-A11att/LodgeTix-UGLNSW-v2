-- =====================================================
-- FIX TICKET PROCESSING WITHOUT SKIPPING TICKETS
-- Since event_id FK requirement has been removed
-- =====================================================
...
BEGIN
    ...
    -- Process tickets (NO SKIPPING - FK requirement removed)
    IF p_registration_data->'tickets' IS NOT NULL THEN
        ...
        LOOP
            ...
            INSERT INTO tickets (
                ...
                gen_random_uuid(),
                v_attendee_id,
                COALESCE(v_ticket_event_id, (v_ticket->>'eventId')::uuid), -- Can be NULL now
