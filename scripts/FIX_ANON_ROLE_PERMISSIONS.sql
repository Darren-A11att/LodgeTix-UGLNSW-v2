-- =====================================================
-- FIX RPC FUNCTION PERMISSIONS FOR ANON ROLE
-- This ensures the function works for both service and anon roles
-- =====================================================

-- First, ensure the function exists and grant permissions
...
-- Also grant table permissions that the function needs
GRANT INSERT, UPDATE, SELECT ON "public"."customers" TO "anon";
GRANT INSERT, UPDATE, SELECT ON "public"."registrations" TO "anon";
GRANT INSERT, UPDATE, SELECT ON "public"."attendees" TO "anon";
GRANT INSERT, UPDATE, SELECT ON "public"."tickets" TO "anon";
GRANT INSERT, UPDATE, SELECT ON "public"."contacts" TO "anon";
GRANT INSERT, SELECT ON "public"."raw_registrations" TO "anon";

-- Grant sequence usage
GRANT USAGE ON ALL SEQUENCES IN SCHEMA "public" TO "anon";

-- Update the function to ensure it has proper security settings
