-- =====================================================
-- FIX THE EXACT JSONB SYNTAX ERROR IN TICKET PROCESSING
-- Line 312: v_attendee_id := (v_attendee_ticket_map->>v_ticket->>'attendeeId')::uuid;
-- =====================================================
...
BEGIN
    ...
    -- Process tickets with FIXED JSONB SYNTAX
    IF p_registration_data->'tickets' IS NOT NULL THEN
        ...
        LOOP
            -- FIXED: Map frontend attendee ID to database attendee ID with correct syntax
