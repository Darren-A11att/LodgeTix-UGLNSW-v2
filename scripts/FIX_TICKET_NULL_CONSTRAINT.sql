-- =====================================================
-- FIX NULL CONSTRAINT ERROR IN TICKET PROCESSING
-- Make event_id optional or provide default values
-- =====================================================
...
BEGIN
    ...
    -- Process tickets with FIXED NULL CONSTRAINT HANDLING
    IF p_registration_data->'tickets' IS NOT NULL THEN
        ...
        LOOP
            ...
            -- SKIP TICKETS WITHOUT VALID EVENT_ID TO AVOID NULL CONSTRAINT
            IF v_ticket_event_id IS NULL AND v_ticket->>'eventId' IS NULL THEN
