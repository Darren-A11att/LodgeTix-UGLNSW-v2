-- Create upsert_delegation_registration function for consistency
-- This ensures delegations are handled the same way as individuals and lodges
...
BEGIN
    ...
    IF p_registration_data->'delegates' IS NOT NULL THEN
        ...
        LOOP
            ...
            -- Store delegation role and masonic data
            UPDATE attendees 
