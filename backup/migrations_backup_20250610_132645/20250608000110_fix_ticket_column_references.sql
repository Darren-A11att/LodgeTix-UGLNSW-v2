-- Fix ticket column references in lodge registration RPC function
-- First, let's check what columns exist in the tickets table and fix the references
  ...
  IF p_package_id IS NOT NULL THEN
    ...
    LOOP
      ...
      FOR v_i IN 1..v_ticket_count LOOP
        -- FIXED: Remove ticket_number column reference since it doesn't exist
        INSERT INTO tickets (
          ticket_id,
          attendee_id,
          registration_id,
