-- Fix payment_status enum casting in lodge registration RPC function
...
BEGIN
  ...
  -- Create or update customer record (FIXED: removed non-existent columns)
  ...
  -- Create booking contact record with FIXED contact type
  ...
  INSERT INTO contacts (
    ...
    'individual',  -- FIXED: Changed from 'customer' to 'individual'
    p_booking_contact->>'firstName',
    p_booking_contact->>'lastName',
    p_booking_contact->>'email',
    COALESCE(p_booking_contact->>'mobile', p_booking_contact->>'mobileNumber', p_booking_contact->>'phone'),
  ...
  INSERT INTO registrations (
    ...
    'lodge',
    v_status,
    p_payment_status::payment_status,  -- FIXED: Cast to payment_status enum
